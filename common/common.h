...
struct common_params {
    ...
    int32_t n_ubatch              =  2048; // physical batch size for prompt processing (must be >=32 to use BLAS) - 512→2048 for GLM-5.3-Flash long-context prefill (4× fewer ubatches, 4× fewer host kpool builds)
