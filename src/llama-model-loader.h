...
struct llama_model_loader {
    ...
    bool has_q8_outlier_metadata() const;

    struct llama_q8_outlier_tensor_meta {
    ...
    bool has_q2k_outlier_metadata() const;

    struct llama_q2k_outlier_tensor_meta {
        std::string base_name;
        std::string idx_name;
        std::string values_name;
        uint32_t n_blocks = 0;
    ...
    std::vector<llama_q2k_outlier_tensor_meta> read_q2k_outlier_metadata();
};
