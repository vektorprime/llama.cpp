...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q8_16B] = {
        .type_name                = "q8_16",
        .blck_size                = QK8_16B,
        .type_size                = sizeof(block_q8_16),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q8_16,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q8_16_ref,
    },
    [GGML_TYPE_Q8_1] = {
        .type_name                = "q8_1",
        .blck_size                = QK8_1,
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q8_16B:  result = quantize_q8_16  (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
