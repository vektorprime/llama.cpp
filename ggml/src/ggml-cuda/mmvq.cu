...
static constexpr __device__ vec_dot_q_cuda_t get_vec_dot_q_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q8_16B:  return vec_dot_q8_16_q8_1;
...
static constexpr __host__ __device__ int get_vdr_mmvq(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q8_16B:  return VDR_Q8_0_Q8_1_MMVQ;
...
static constexpr __host__ __device__ int get_mmvq_mmid_max_batch_pascal_older(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q8_16B:  return 4;
...
static constexpr __host__ __device__ int get_mmvq_mmid_max_batch_rdna4(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q8_16B:  return 7;
        default:                return MMVQ_MAX_BATCH_SIZE;
    }
}
...
static void mul_mat_vec_q_switch_type(
    ...
    switch (type_x) {
        ...
        case GGML_TYPE_Q8_0:
            ...
            break;
        case GGML_TYPE_Q8_16B:
            mul_mat_vec_q_switch_ncols_dst<GGML_TYPE_Q8_16B>
                (vx, vy, ids, fusion, dst, ncols_x, nrows_x, ncols_dst, stride_row_x, stride_col_y, stride_col_dst,
                 nchannels_x, nchannels_y, nchannels_dst, stride_channel_x, stride_channel_y, stride_channel_dst,
                 nsamples_x, nsamples_dst, stride_sample_x, stride_sample_y, stride_sample_dst, ids_stride, stream);
            break;
