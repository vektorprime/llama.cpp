        ...
        case GGML_OP_SET_ROWS:
            {
                return (op->type == GGML_TYPE_F32 || op->type == GGML_TYPE_F16 || op->type == GGML_TYPE_BF16 ||
                       ...
                       op->type == GGML_TYPE_Q5_1 || op->type == GGML_TYPE_Q8_0 || op->type == GGML_TYPE_Q8_16B ||
        ...
        case GGML_OP_CPY:
            {
                ...
                if (src0_type == GGML_TYPE_F32 && src1_type == GGML_TYPE_Q8_16B) {
                    return true;
                }
                if (src0_type == GGML_TYPE_Q8_16B && src1_type == GGML_TYPE_F32) {
                    return true;
                }
