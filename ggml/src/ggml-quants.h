...
GGML_API void quantize_row_q4_K_impl(const float * GGML_RESTRICT x, block_q4_K * GGML_RESTRICT y, int64_t n_per_row, const float * quant_weights);
GGML_API void quantize_row_q4_K_M_CLONE_ref(const float * GGML_RESTRICT x, block_q4_K_M_CLONE * GGML_RESTRICT y, int64_t k);
...
GGML_API void ggml_q2k_set_diffusion(float d);
GGML_API float ggml_q2k_get_diffusion(void);
GGML_API void ggml_q2k_set_layer_diffusion(bool enable, float attn, float mlp, float lmhead, float other);
GGML_API void ggml_q2k_set_diffusion_for_tensor(const char * name);
...
GGML_API void dequantize_row_q4_K_M_CLONE(const block_q4_K_M_CLONE * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_q4_K_M_CLONE(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
...
GGML_API void ggml_iq2xxs_set_per_tensor_grid(const uint64_t * grid);
GGML_API const uint64_t * ggml_iq2xxs_get_per_tensor_grid(void);
GGML_API const uint64_t * iq2xxs_get_learned_grid(void);
GGML_API void ggml_iq2xxs_set_learn_codebook(bool enable);
GGML_API bool ggml_iq2xxs_get_learn_codebook(void);
