...
## Validation test
```
/home/user/llm/dup_layers_llama/llama.cpp/build/bin/llama-completion \
...
--loop-layer-start 24 --loop-layer-stop 35 --custom-logs --single-turn   -lv 4 \
-p "hello, can you count to 100"
```

## Debugging
- Use --custom-logs for debug loggin
- For crashes with massive logs, redirect to file
- Check VRAM with nvidia-smi

## Hardware Scope
- Only CUDA, CPU, tensor split, and MTP pipelines
